...
**一句话总结关系：** Prompt 是你和 LLM 对话的语言，Context Window 决了你能说多少，Workflow 和 Agent 是组织 LLM 调用的两种模式（固定流程 vs 自主决策），Tool Use 让 LLM 能做事而不只是说话，Guardrails 和 Human-in-the-Loop 负责安全兜底，Tracing 让一切可观测，AI Coding 是这些能力在编程领域的具体落地。
